...
from utility import MoveValidator,IsKingInCheck,ToPositionInFENNotation,IsThisStalemate,ListEveryLegalMove
import copy
...
def CheckForEndgameConditions(ChessBoard,WhiteToMove):
    if len(ListEveryLegalMove(ChessBoard,WhiteToMove,Castle))==0 and IsKingInCheck(ChessBoard,WhiteToMove,Castle):
        print("That is Mate")
